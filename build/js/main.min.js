...
},{"./modules/form-validate/form":4,"./modules/init-swiper":10,"./modules/tab":11,"./modules/video":12,"./utils/ios-vh-fix":14}],3:[function(require,module,exports){
"use strict";
...
_swiperBundle.default.use([_swiperBundle.Navigation, _swiperBundle.Pagination]);
var initStaffSwiper = function initStaffSwiper() {
  var staffSlider = new _swiperBundle.default('.swiper--staff', {
    // eslint-disable-line
    direction: 'horizontal',
    loop: true,
    navigation: {
...
var initFeedbackSwiper = function initFeedbackSwiper() {
  var feedbackSlider = new _swiperBundle.default('.swiper--feedback', {
    // eslint-disable-line
    direction: 'horizontal',
    navigation: {
...
var tabButtons = tab.querySelectorAll('[data-tab-button]');
var tabContainers = tab.querySelectorAll('[data-tab-content]');
var onTabClick = function onTabClick(event) {
  ...
  var activeTabPanel = tab.querySelector("[aria-label=\"".concat(id, "\"]"));
  if (activeTabPanel) {
    activeTabPanel.hidden = false;
  }
};
tabButtons.forEach(function (button) {
  return button.addEventListener('click', onTabClick);
});
